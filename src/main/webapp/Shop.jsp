                    ...
                    <nav class="flex justify-center items-center gap-2 mt-12">
                        ...
                        <c:if test="${endPage > 1}">
                            ...
                            <c:if test="${currentPage > 1}">
                                <a href="shop?page=${i}&keyword=${keyword}&categoryId=${categoryId}&brandId=${brandId}&sort=${sort}"
                            ...
                            <c:if test="${currentPage < endPage}">
                                <a href="shop?page=${currentPage + 1}&keyword=${keyword}&categoryId=${categoryId}&brandId=${brandId}&sort=${sort}"
                                   class="w-10 h-10 flex items-center justify-center rounded-lg border border-gray-300 hover:bg-gray-100">
