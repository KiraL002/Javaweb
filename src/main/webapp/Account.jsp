                                ...
                                <table class="min-w-full border border-gray-200 rounded-lg overflow-hidden">
                                    <thead class="bg-gray-100">
                                        <tr>
                                            ...
                                            <th class="px-4 py-2 text-left">Tổng cộng</th>
                                            ...
                                            <tr class="odd:bg-gray-50 even:bg-white hover:bg-gray-100">
                                                ...
                                                <td class="px-4 py-2">
                                                    <span class="px-2 py-1 rounded-full text-white
                                                            ${o.status=='Đã giao' ? 'bg-green-500' : (o.status=='Chờ xác nhận' ? 'bg-yellow-500' : 'bg-red-500')}">
                                                        ${o.status}
                                                    </span>
                                                </td>
                                                <td class="px-4 py-2">
                                                    <%-- KHỐI 3: CỘT HÀNH ĐỘNG (ĐÃ NÉN JSTL) --%>
                                                    <c:choose><c:when test="${o.status eq 'Chờ xác nhận'}">
                                                            <button type="button"
                                                                    class="cancel-order-btn text-red-600 hover:text-red-800 font-semibold flex items-center gap-1"
