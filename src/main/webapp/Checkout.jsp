...
<body class="bg-[#FAFAF9]">
    ...
    <div class="min-h-screen pt-20">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <h1 class="text-3xl md:text-4xl font-bold mb-8">Thanh toán</h1>
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="text" name="fullName" id="fullName" 
                                       value="${requestScope.acc.fullName}" 
                                ...
                                <div class="space-y-3">
                                    <label class="flex items-center p-4 border rounded-lg cursor-pointer hover:bg-gray-50">
                                        <input type="radio" name="paymentMethod" value="COD" 
                                               class="h-4 w-4 text-[#BFA77F] focus:ring-[#BFA77F]" checked>
                                    ...
                                    <label class="flex items-center p-4 border rounded-lg cursor-pointer hover:bg-gray-50">
                                        <input type="radio" name="paymentMethod" value="VNPay" 
                                               class="h-4 w-4 text-[#BFA77F] focus:ring-[#BFA77F]">
                                        <span class="ml-3 block text-sm font-medium text-gray-700">
                    ...
                    <div class="lg:col-span-1">
                        <div class="bg-white rounded-xl p-6 shadow-sm sticky top-24">
                            ...
                            <div class="space-y-4 max-h-60 overflow-y-auto mb-4 pr-2">
                                <c:forEach items="${sessionScope.cartItemsForCheckout}" var="item">
                                    <div class="flex gap-3">
                                        <img src="${item.product.displayImage}" alt="${item.product.name}" class="w-16 h-16 rounded-lg object-cover">
                                        <div class="flex-1">
                                ...
                                <div class="flex justify-between text-gray-600">
                                    <span>Tạm tính:</span>
                                    <span>
                                        <fmt:formatNumber value="${sessionScope.subtotalForCheckout}" type="currency" currencyCode="VND"/>
                                    </span>
                                </div>
                                <div class="flex justify-between text-gray-600">
                                    ...
                                    <span>
                                        <c:choose>
                                            <c:when test="${sessionScope.shippingForCheckout == 0}">Miễn phí</c:when>
                                            <c:otherwise>
                                                <fmt:formatNumber value="${sessionScope.shippingForCheckout}" type="currency" currencyCode="VND"/>
                                            </c:otherwise>
                                        </c:choose>
                                    </span>
                                </div>
                                <div class="flex justify-between text-xl font-bold">
                                    <span>Tổng cộng:</span>
                                    <span class="text-[#BFA77F]">
                                        <fmt:formatNumber value="${sessionScope.totalForCheckout}" type="currency" currencyCode="VND"/>
                                    </span>
                                </div>
